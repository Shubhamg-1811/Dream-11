...
json_dir = "./all_json"
output_csv = "./CSVs/match_data3.csv"
...
csv_fields = [
    ...
    'wickets', 'runs_conceded', 'stumpings', 'out', 'date', 'venue', 'match_type','gender'
]
...
with open(output_csv, mode="w", newline="") as csv_file:
    ...
    for file_name in os.listdir(json_dir):
        ...
        # Check if match type is not "Test"
        ...
        # Debug: Log file name being processed
