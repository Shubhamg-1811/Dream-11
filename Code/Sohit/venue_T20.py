...
# Load the dataset
df = pd.read_csv('../../CSVs/fantasy_points/T20_MatchWise_fantasy_points.csv')
...
for index, row in df.iterrows():
    ...
    stats['thirties'] += 1 if 30 <= row['runs_scored'] < 50 else 0  # Only count thrties if not fifties
...
df.to_csv('../../CSVs/Final/T20/venue_t20.csv', index=False)
