...
json_dir = "./all_json"
output_csv = "./CSVs/Overall_MatchWise.csv"

# Ensure the output directory exists
output_dir = os.path.dirname(output_csv)
os.makedirs(output_dir, exist_ok=True)

# List of fields for the CSV, including 'team_name'
csv_fields = [
    'match_id', 'player_id', 'player_name', 'runs_scored', 'balls_faced', 'no_of_fours', 'no_of_sixes',
    'no_of_catches', 'runouts', 'balls_bowled', 'dot_balls', 'wickets', 'LBWs/Bowled', 'runs_conceded',
    'stumpings', 'out', 'date', 'venue', 'match_type', 'gender', 'team_name'
]
...
with open(output_csv, mode="w", newline="") as csv_file:
    ...
    for file_name in os.listdir(json_dir):
        ...
        match_gender = match_data['info']['gender']
        ...
        player_stats = defaultdict(lambda: {
            ...
            'gender': match_gender,
            'team_name': ""  # Placeholder for team name
        })
                    ...
                    if 'wickets' in delivery:
                        for wicket_info in delivery['wickets']:
                            ...
                            if wicket_info['kind'] == 'caught':
                                ...
                                fielder = wicket_info.get('fielders', [{}])[0].get('name')
                                if fielder:
                                ...
                                player_stats[bowler]['wickets'] += 1
                                stumper = wicket_info.get('fielders', [{}])[0].get('name')
                                if stumper:
        ...
        for player, stats in player_stats.items():
            stats_row = {'player_name': player, **stats}
